return {
    ...
    keys = {
        ...
        { "<Leader>x", ":Oneterm send_visual_lines<CR>", mode = "v", desc = "Send visual lines to the terminal", silent = true },
        { "<Leader>X", ":normal vip<CR>:Oneterm send_visual_lines<CR>", desc = "Send paragraph to the terminal", silent = true },
